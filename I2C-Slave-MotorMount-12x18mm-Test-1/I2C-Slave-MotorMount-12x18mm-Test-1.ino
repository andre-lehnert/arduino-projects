...
void receiveEvent(int howMany) {
 ...
 debug(functionSpeed);
  ...
  // DO MESSAGE COMMANDS
  //int tPos = targetPosition.toInt();
  //moveTo(tPos);
  
  if (function == "loading") {
    loadingBarsLED(r.toInt(), g.toInt(), b.toInt(), functionSpeed.toInt()*20);
    delay(100);
    disableAllLED();
    delay(50);
  }
